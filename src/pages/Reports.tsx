			...
			>
								...
								<CardContent className="h-80">
									<ResponsiveContainer width="100%" height="100%">
										...
										>
											...
											<XAxis dataKey="month" tickFormatter={(m) => `${m}`.padStart(2, '0')} />
												...
												>
													...
													<div className="text-right">
														...
														<p className="text-xs text-gray-500">
															{(
																(category.amount / arr.reduce((sum, cat) => sum + cat.amount, 0)) *
																100
															).toFixed(1)}
															% dari total
														</p>
				...
				<TabsContent value="trends" className="space-y-6">
					...
					<Card>
						<CardHeader>
							<CardTitle>Pola Pengeluaran</CardTitle>
							<CardDescription>Visualisasi pengeluaran Anda sebagai grafik area</CardDescription>
						</CardHeader>
						<CardContent className="h-80">
							<ResponsiveContainer width="100%" height="100%">
						...
						<Card>
							...
							<CardContent>
								<div className="flex flex-col">
									...
									<span className="text-3xl font-bold text-primary">{formatCurrency(149_99)}</span>
						...
						<Card>
							...
							<CardContent>
								<div className="flex flex-col">
									...
									<span className="text-3xl font-bold text-green-600">{formatCurrency(12_50)}</span>
									<p className="text-sm text-gray-500 mt-1">Pengeluaran utama: Kopi dan makanan</p>
								</div>
							</CardContent>
						</Card>
